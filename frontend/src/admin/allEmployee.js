              ...
              return (
                  ...
                  title={
                    <div className="flex items-center">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center">
                        <span className="text-sm sm:text-base">{firstName}</span>
                        {lastName && (
                          <span className="text-sm sm:text-base sm:ml-1">{lastName}</span>
                        )}
                      </div>
                    </div>
                  }
                ...
                >
                  ...
                  <details className="mt-3">
                    <summary className="cursor-pointer text-blue-500">Emergency Contact</summary>
