...
export default function AddItemModal({
  ...
  const laundryOptions = [
    ...
    },
    {
      ...
      price: 350,
      description:
        "Express wash and dry for bedsheets or towels, priced per kg",
    },
    {
      ...
      price: 300,
      description:
        "Wash, dry, and press normal clothes, minimum 3 days, priced per kg",
    },
    {
  ...
  const curtainsCleaningOptions = [
    ...
    },
    {
      ...
      price: 0,
      description:
        "Comprehensive cleaning, pressing, and care for premium curtains",
    },
    {
      ...
      price: 0,
      description:
        "Professional removal of curtains for cleaning or replacement",
    },
    {
      ...
      price: 0,
      description:
        "Professional installation of curtains after cleaning or replacement",
    },
  ];
  ...
  const sofaCarpetCleaningOptions = [
    {
      ...
      price: 0,
      description:
        "Deep shampoo and vacuum cleaning for upholstery and carpets",
    },
    {
      value: "Sofa",
      label: "Sofa Cleaning",
    ...
    },
    {
      ...
      price: 0,
      description:
        "Deep cleaning for carpets, including stain and odor removal",
    },
  ];
  ...
  const DomesticCleaningOptions = [
    ...
    },
    {
      ...
      price: 0,
      description:
        "Standard cleaning for homes, including dusting and vacuuming",
    },
    {
        ...
        if (editable && options.length > 0) {
          ...
          return (
            <Input
              value={text}
              onChange={(e) =>
                handleFieldChange(record.key, "items", e.target.value)
              }
              ...
              <div className="w-1/2">
                ...
                {isEditing(record) ? (
                  <InputNumber
                    ...
                    value={record.qty}
                    onChange={(value) =>
                      handleFieldChange(record.key, "qty", value)
                    }
                    className="w-full"
                  />
                ) : (
              ...
              <div className="w-1/2">
                ...
                {isEditing(record) ? (
                  <InputNumber
                    ...
                    parser={(val) => val.replace("Rs. ", "")}
                    onChange={(value) =>
                      handleFieldChange(record.key, "price", value)
                    }
                    className="w-full"
                  />
                ) : (
